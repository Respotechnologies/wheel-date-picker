...
export default class DatePicker extends PureComponent {
  ...
  static defaultProps = {
    ...
    minimumDate: new Date("01-01-1942"),
    date: new Date("10-15-1998"),
    style: null,
    textColor: 'black',
    textSize: 22,
    itemSpace: 20,
  ...
  constructor(props) {
    ...
    //   this.state.monthRange.push({ value: i, label: `${monthNames[i]}` });
    // }
  ...
  genDateRange(dayNum) {
    ...
    for (let i = 1; i <= dayNum; i += 1) {
      days.push({ value: i, label: `${i<=9?'0':''}${i}${this.props.labelUnit.date}` });
    }
